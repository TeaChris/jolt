...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        limit: zod_1.z.number().min(1).max(100), //number of products to get
        cursor: zod_1.z.number().nullish(), // where to begin fetching the next page
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()]; // connect to db
                    case 1:
                        payload = _c.sent() // connect to db
                        ;
                        parsedQueryOpts = {};
